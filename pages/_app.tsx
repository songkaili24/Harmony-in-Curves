    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="An algorithmic art project based on mathematics to draw seemingly random curves"
        />
        <meta name="description" content="An algorithmic art project based on mathematics to draw seemingly random curves" />
